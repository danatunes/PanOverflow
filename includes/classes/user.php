            ...
            if(!empty($this->user_name) && !empty($this->user_email) && !empty($this->user_pass)){
                ...
                if (filter_var($this->user_email, FILTER_VALIDATE_EMAIL)) { 
                    ...
                    if($check_email->rowCount() > 0){
                        ...
                        $sql = "INSERT INTO `users` (username, user_email, user_password, user_image,role) VALUES(:username, :user_email, :user_pass, :user_image,:role)";
                        ...
                        $user ="user";
                        $sign_up_stmt->bindValue(':role',$user, PDO::PARAM_STR);
